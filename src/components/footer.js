...
const pluginCard = ({author}) => (
    ...
    <Footer>
        <Website>
            ...
            <Social>
                <a href="https://www.facebook.com/CylinderHeadExchangeShop/" target="blank" aria-label="Check out our Facebook!" rel="noopener noreferrer">
                    <Icon>
                        <svg
                ...
                <a href="https://www.instagram.com/cylinderheadexchangeshop/" target="blank" aria-label="Check out our Instagram!" rel="noopener noreferrer">
                    <Icon>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="169.063"
        ...
        <CategoryContact>
            ...
            <ul>
                <li>
                    ...
                    <a href="tel:909-282-5198" target="blank" rel="noopener noreferrer">{data.contentfulWebsiteInformation.shopInformation.phoneNumber}</a>
                </li>
                <li>
                    <svg
                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a href="https://www.google.com/maps/dir//Cylinder+Head+Exchange,+5498+W+Mission+Blvd+A,+Ontario,+CA+91762/@34.0565074,-117.7555996,12z/data=!3m1!4b1!4m8!4m7!1m0!1m5!1m1!1s0x80c333c0eb3839e5:0xae9d7fc2b83f00bd!2m2!1d-117.685559!2d34.056385" target="blank" rel="noopener noreferrer">{data.contentfulWebsiteInformation.shopInformation.address}</a>
                </li>
            </ul>
        </CategoryContact>
    </Footer>
