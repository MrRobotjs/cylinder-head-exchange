...
const Slideer = ({Name}) => {
    ...
    return (
    <Test onDragStart={handleOnDragStart}>
        <Left>
            <IconContainer>
                <Icon>
            ...
            <Button onClick={() => this.Carousel.slidePrev()}>Previous</Button>
        ...
        <Right>
            ...
            <Desc>Relatively small shop but got the job done fairly quickly. Quick inspection and job took less than an hour. Th...</Desc>
            <Name>Antonio Magana</Name>
            ...
            ref={(el) => (this.Carousel = el)}>
                <Test onDragStart={handleOnDragStart}>
                    ...
                    <Right>
                        ...
                        <Desc>Fast and easy service! Would definitely recommend to anyone. I got service as soon as I got there. Problem for my car was found and fixed immediately and would definitely come back!</Desc>
                        <Name>Christopher Ramos</Name>
                        <Title>Google Reviewer</Title>
                    </Right>
                    <ButtonContainer>
                        <Button onClick={() => this.Carousel.slidePrev()}>
                ...
                <Test onDragStart={handleOnDragStart}>
                    ...
                    <Right>
                        ...
                        <Desc>Es un lugar bien rapido. Mi hicieron un cambió de cabeza de cilindros en my GMC Yukon y salio perfecto.</Desc>
                        <Name>Eugenio Garcia</Name>
                        <Title>Google Reviewer</Title>
                    </Right>
                    <ButtonContainer>
                        <Button onClick={() => this.Carousel.slidePrev()}>
                ...
                <Test onDragStart={handleOnDragStart}>
                    ...
                    <Right>
                        ...
                        <Desc>Really good service would highly recommend it to any other person</Desc>
                        <Name>Luis Amescua</Name>
                        <Title>Google Reviewer</Title>
                    </Right>
                    <ButtonContainer>
                        <Button onClick={() => this.Carousel.slidePrev()}>
                ...
                <Test onDragStart={handleOnDragStart}>
                    ...
                    <Right>
                        ...
                        <Desc>Relatively small shop but got the job done fairly quickly. Quick inspection and job took less than an hour. The owner was very helpful and fair. Highly recommended.</Desc>
                        <Name>Christopher Ramos</Name>
                        <Title>Google Reviewer</Title>
                    </Right>
                    <ButtonContainer>
