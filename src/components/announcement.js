...
const Facebook = ({ Username }) => {
    return (
      <Icon href={"https://facebook.com/" + Username} target="_blank" title="Follow us on Facebook!">
...
const Instagram = ({ Username }) => {
  return (
    <Icon href={"https://instagram.com/" + Username} target="_blank" title="Follow us on Instagram!">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
